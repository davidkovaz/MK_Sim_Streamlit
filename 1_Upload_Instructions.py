...
st.markdown('Yes! You may download the default data file [here](https://github.com/davidkovaz/MK_Sim_Streamlit/blob/80be8d254b44912b3e2ec74c30696ceda283b6cd/va_12_19.csv) to see an example of a correctly formatted data file.')
